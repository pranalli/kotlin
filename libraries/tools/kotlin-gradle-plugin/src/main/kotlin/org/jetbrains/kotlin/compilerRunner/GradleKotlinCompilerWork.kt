...
internal class GradleKotlinCompilerWork @Inject constructor(
        ...
        return try {
            ...
            reportExecutionResultIfNeeded {
                TaskExecutionResult(
                    ...
                    icLog = nonIcBuildMessage("incremental compilation is not enabled for '$taskPath'")
                )
            }
        }
    }
    ...
    private fun incrementalCompilationWithDaemon(
        ...
        reportExecutionResultIfNeeded {
            TaskExecutionResult(
                executionStrategy = DAEMON_EXECUTION_STRATEGY,
                icLog = compilationResults.icLog
            )
        }
        ...
        try {
            ...
            reportExecutionResultIfNeeded {
                TaskExecutionResult(
                    ...
                    icLog = nonIcBuildMessage("$OUT_OF_PROCESS_EXECUTION_STRATEGY execution strategy does not support incremental compilation")
                )
            }
        }
        ...
        try {
            ...
            reportExecutionResultIfNeeded {
                TaskExecutionResult(
                    ...
                    icLog = nonIcBuildMessage("$IN_PROCESS_EXECUTION_STRATEGY execution strategy does not support incremental compilation")
                )
            }
        }
    }
    ...
    private fun nonIcBuildMessage(reason: String): String =
        "Performing non-incremental build: $reason"
}